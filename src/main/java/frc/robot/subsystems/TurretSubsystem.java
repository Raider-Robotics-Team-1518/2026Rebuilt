...
public class TurretSubsystem extends SubsystemBase {
  ...
  private final int canID = Constants.Motors.turretMotorID;
  ...
  private final double maxVelocity = 0.5; // rad/s
  private final double maxAcceleration = 0.5; // rad/s²
  ...
  public TurretSubsystem() {
    ...
    // motorConfig.closedLoop.feedForward.kV(kV).kA(kA);
